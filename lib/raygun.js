...
var Raygun = function () {
  var _apiKey, _filters, raygun = this, _user, _version, _host, _port, _useSSL, _onBeforeSend;
  ...
  raygun.expressHandler = function (err, req, res, next) {
    var customData = typeof raygun.expressCustomData === 'function' ? raygun.expressCustomData(err, req) : raygun.expressCustomData;
